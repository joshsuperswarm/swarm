...
export function Sidebar({ onCreateTask }: SidebarProps) {
  ...
  return (
    <>
          ...
          <div className="space-y-2">
            ...
            `}>
              <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
              </svg>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 border-t bg-white safe-pb z-40">
        <div className="max-w-screen-sm mx-auto px-3 py-2 flex items-center justify-between">
          ...
          {onCreateTask && (
            <button
              onClick={onCreateTask}
              className="mx-2 px-4 py-2 rounded-md bg-gray-900 text-white text-sm touch-target"
